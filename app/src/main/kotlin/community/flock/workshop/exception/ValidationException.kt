...
sealed class ValidationException(what: String) : AppException("$what is not valid")

sealed class UserValidationException(what: String) : ValidationException(what)
...
sealed class NoteValidationException(what: String) : ValidationException(what)
