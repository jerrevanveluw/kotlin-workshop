...
@JvmInline
value class Email private constructor(override val value: String) : Value<String> {
...
@JvmInline
value class BirthDate private constructor(override val value: LocalDate) : Value<LocalDate> {
    override fun toString() = value.toString()

    companion object {
        operator fun invoke(value: String) =
            Either.catch { LocalDate.parse(value, ISO_LOCAL_DATE) }
